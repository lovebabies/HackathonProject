...
class MainActivity : BaseActivity(), MainView {
    ...
    lateinit var mMentorRefence: DatabaseReference
    lateinit var mUserMessageReference: DatabaseReference
        ...
        when(it.id) {
            R.id.btnSend -> {
              /*  mMessageAdapter.addMessage(
                ...
                val response = FakeResponse.response(edtUserInput.text.toString())
                mMessageAdapter.addMessage(
                    Message(
                        System.currentTimeMillis(),
                        response,
